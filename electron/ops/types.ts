...
export type OpsActionLevel = 'L0' | 'L1' | 'L2';
...
export type OpsSymptomCode =
  | 'gateway_not_running'
  | 'gateway_health_failed'
  | 'openclaw_validation_issue'
  | 'local_model_service_down'
  | 'team_runtime_error';
...
export interface OpsPersistedState {
  ...
  events: OpsEvent[];
  actions: OpsActionRecord[];
  lastSnapshot?: OpsHealthSnapshot;
  lastDoctorAt?: string;
  lastDoctorOk?: boolean;
}
