...
const WORKER_BOOTSTRAP_SCRIPT = [
  ...
  "    'Response contract: keep answers concise, prefer bullets, avoid markdown tables, use at most 5 bullets, and stay under 140 words unless the task strictly requires more.'",
  "  ].filter(Boolean).join('\\n\\n');",
  '  let lastError = null;',
