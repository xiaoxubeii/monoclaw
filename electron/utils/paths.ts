...
export function getOpenClawConfigDir(): string {
  ...
  return getAssistantDataLayout().openclawStateDir;
}
...
/**
 * Get Monoclaw config directory
 */
export function getMonoclawConfigDir(): string {
  return getAssistantDataLayout().monoclawConfigDir;
}

/**
 * Get Monoclaw logs directory
 */
...
/**
 * Get monoclaw_data root directory
 */
export function getAssistantDataRootDir(): string {
  return getAssistantDataLayout().root;
}
