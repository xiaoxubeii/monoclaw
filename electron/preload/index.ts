  ...
  ipcRenderer: {
    invoke: (channel: string, ...args: unknown[]) => {
      const validChannels = [
        ...
        'openclaw:status',
        'openclaw:isReady',
        'assistantData:getStatus',
        'assistantData:runHealthCheck',
        // Shell
        'shell:openExternal',
        ...
        // Local model
        'localModel:status',
        'localModel:installRuntime',
        'localModel:pullPreset',
        ...
        'ops:actions:list',
        'ops:runCheckNow',
        'ops:pauseAutoRemediation',
        'ops:resumeAutoRemediation',
        // Cron
        'cron:list',
        'cron:create',
        'cron:update',
        ...
        // Voice Call plugin
        'voicecall:getConfig',
        'voicecall:saveConfig',
        'voicecall:initiate',
        'voicecall:continue',
        'voicecall:speak',
        'voicecall:end',
        'voicecall:status',
        'voicecall:mockSmokeTest',
        // OpenClaw extras
        'openclaw:getDir',
